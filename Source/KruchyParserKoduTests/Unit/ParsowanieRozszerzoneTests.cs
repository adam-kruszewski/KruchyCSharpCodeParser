...
namespace KruchyParserKoduTests.Unit
{
    ...
    public class ParsowanieRozszerzoneTests
    {
        ...
        {
            //arrange
            var metoda = parsowane.DefinedItems.First().Methods.First();
        ...
        {
            //arrange
            var metoda = parsowane.DefinedItems.First().Methods[2];
        ...
        {
            //arrange
            var metoda = parsowane.DefinedItems.First().Methods[1];
